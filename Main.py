...
grid_search_poly = GridSearchCV(svm_clf_poly, param_grid_poly, cv=3)
...
grid_search_rbf = GridSearchCV(svm_clf_rbf, param_grid_rbf, cv=3)
...
grid_search_linear = GridSearchCV(svm_clf_linear, param_grid_linear, cv=3)
